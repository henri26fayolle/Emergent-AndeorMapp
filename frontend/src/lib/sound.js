...
// Ambient music has been removed at the user's request. The functions are kept
// as no-ops so existing imports (Dashboard mounts) don't break. UI sound effects
// (click / select / chime / unlock / openScene) are unaffected.
export function startAmbient() { /* intentionally empty */ }
export function stopAmbient()  { /* intentionally empty */ }
